    ...
    <div className="min-h-screen bg-[var(--background)]">
      <div className="mx-auto max-w-[780px] px-4 py-6">
        <Masthead volume="North American Edition">
          <div className="flex w-full min-w-0 flex-col gap-2 sm:max-w-md sm:flex-row sm:items-center sm:gap-4">
            <Link
              href="/"
              className="font-body shrink-0 text-[var(--blue-accent)] underline decoration-dotted hover:decoration-solid focus:outline-none focus:ring-2 focus:ring-[var(--blue-accent)] focus:ring-offset-2"
            >
              ← Search
            </Link>
        ...
        {overlay?.generation && (
          <nav
            className="mt-4 min-w-0 break-words font-mono text-[0.7rem] uppercase tracking-wider text-[var(--ink-faint)]"
          ...
          >
            ...
            <span className="text-[var(--ink)]" title={displayHeadword}>
              {displayHeadword}
            </span>
          </nav>
        )}
